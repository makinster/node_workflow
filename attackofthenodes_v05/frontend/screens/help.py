            ...
            yield Static(
                "\n".join(
                    [
                        ...
                        "  A/D or left/right    Cycle open branch views",
                        "  Ctrl+A/D or Ctrl+arrows  Cycle Branch End views",
                        "  Enter or E           Edit selected node / branch selector",
                        "  I                    Insert after highlighted node",
                        "  Ctrl+I               Add to end of branch",
                        "  B                    Toggle breakpoint",
                        ...
                        "  Ctrl+I adds to the visible branch tail.",
                        "",
                        "Node Config",
